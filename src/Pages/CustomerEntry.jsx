  ...
  return (
    <div className="bg-white shadow-2xl rounded-2xl p-6 md:p-8 border border-blue-200">
      <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white p-4 rounded-xl mb-6 shadow-lg">
        <h2 className="text-2xl font-bold">New Customer Entry</h2>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="flex flex-col items-center">
            <div className="w-40 h-48 border-2 border-gray-300 rounded-lg overflow-hidden bg-gray-50 flex items-center justify-center">
              {selectedImage ? (
                <img src={selectedImage} alt="Customer" className="w-full h-full object-cover" />
              ) : (
          ...
          <div className="md:col-span-2 space-y-4">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="grid grid-cols-2 gap-2">
                <select className="px-3 py-2 border-2 border-gray-300 rounded-lg bg-white font-semibold">
                  <option>S/O</option>
                  <option>D/O</option>
                  <option>W/O</option>
                </select>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="space-y-4">
            <div>
              <label className="text-sm font-bold text-gray-700">Ref-1 Name:</label>
              <input
                type="text"
                className="w-full px-4 py-2 border-2 border-gray-300 rounded-lg"
              />
            ...
            <div>
              <label className="text-sm font-bold text-gray-700">Customer Mobile1:</label>
              <input
                type="text"
                className="w-full px-4 py-2 border-2 border-gray-300 rounded-lg"
              />
          ...
          <div className="space-y-4">
            <div>
              <label className="text-sm font-bold text-gray-700">Ref-2 Ph No.:</label>
              <input
                type="text"
                className="w-full px-4 py-2 border-2 border-gray-300 rounded-lg"
              />
            ...
            <div>
              <label className="text-sm font-bold text-gray-700">Customer Mobile2:</label>
              <input
                type="text"
                className="w-full px-4 py-2 border-2 border-gray-300 rounded-lg"
              />
            ...
            <div>
              <label className="text-sm font-bold text-gray-700">Area/Collection Area:</label>
              <select className="w-full px-4 py-2 border-2 border-gray-300 rounded-lg bg-white font-semibold">
                <option>Select</option>
              </select>
            </div>
        ...
        {/* Navigation Buttons */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 pt-4 border-t-2 border-gray-300">
